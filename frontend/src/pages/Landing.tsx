...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col selection:bg-primary/20">
      ...
      {/* SaaS Footer */}
      <footer className="border-t border-border/10 bg-secondary/20 pt-8 pb-4 px-6 lg:px-16 w-full">
            ...
            <div className="flex items-center gap-2 flex-nowrap md:justify-end w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
              <span className="text-[11px] font-black text-muted-foreground opacity-60 whitespace-nowrap shrink-0">For Support:</span>
                ...
                <a
                  ...
                  aria-label="WhatsApp"
                  className="flex items-center justify-center w-6 h-6 rounded-full bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] transition-all duration-200 hover:scale-110"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2]/10 hover:bg-[#1877F2]/20 text-[#1877F2] transition-all duration-200 hover:scale-110"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3">
