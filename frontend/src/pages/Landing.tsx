      ...
      <footer className="border-t border-border/10 bg-secondary/20 pt-16 pb-8 px-6 lg:px-16 w-full">
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-4 items-start md:items-center">
            ...
            {/* Right: Support */}
            <div className="flex items-center gap-3 flex-nowrap md:justify-end w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
              <span className="text-xs font-black text-muted-foreground opacity-60 whitespace-nowrap shrink-0">For Support:</span>
                <a
          ...
          <div className="border-t border-border/10 pt-8 flex items-center justify-center overflow-hidden">
            <p className="text-[11px] sm:text-xs md:text-sm font-bold text-muted-foreground opacity-60 tracking-wide whitespace-nowrap">
